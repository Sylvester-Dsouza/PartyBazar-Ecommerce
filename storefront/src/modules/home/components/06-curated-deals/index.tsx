    ...
    <section className="py-12">
      <div className="content-container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className={`relative rounded-3xl overflow-hidden h-[300px] md:h-[400px] ${imageErrors['deals']
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 flex flex-col items-start text-left relative z-10">
              ...
              <Button href="/collections/deals" variant="secondary">
                Shop Now
              </Button>
            </div>
          </div>
          ...
          <div className={`relative rounded-3xl overflow-hidden h-[300px] md:h-[400px] ${imageErrors['arrivals']
