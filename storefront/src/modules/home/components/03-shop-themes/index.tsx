        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`w-10 h-10 rounded-full border border-grey-20 flex items-center justify-center transition-all ${canScrollLeft
                  ? 'bg-white text-grey-70 hover:bg-party-dark hover:text-white hover:border-party-dark cursor-pointer'
            ...
            <button
              ...
              className={`w-10 h-10 rounded-full border border-grey-20 flex items-center justify-center transition-all ${canScrollRight
                  ? 'bg-white text-grey-70 hover:bg-party-dark hover:text-white hover:border-party-dark cursor-pointer'
                  : 'bg-grey-5 text-grey-30 cursor-not-allowed opacity-50'
                }`}
            >
        ...
        >
          {themes.map((theme) => (
            ...
            >
              ...
              <p className="mt-3 text-center font-medium text-grey-70 group-hover:text-party-dark transition-colors">
                {theme.name}
              </p>
            </LocalizedClientLink>
          ))}
