...
const CollectionSEOWidget = () => {
  ...
  // Fetch collection data to get existing SEO metadata
  useEffect(() => {
    const fetchCollection = async () => {
      try {
        ...
        const meta_title = (data.collection?.metadata?.meta_title as string) || ""
        const meta_description = (data.collection?.metadata?.meta_description as string) || ""
